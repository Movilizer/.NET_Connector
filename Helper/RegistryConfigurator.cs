...
namespace MWS.WindowsService
{
    ...
    public class RegistryConfigurator : IConfigurator
    {
        ...
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_DB_DRIVER); }
        }

        public string DatabasePath
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_DB_PATH); }
        }

        public string DatabaseUser
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_DB_USER, ""); }
        }

        public string DatabasePassword
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_DB_PASSWORD, ""); }
        }

        public string DatabaseParameters
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_DB_PARAMETERS, ""); }
        }
        ...
        {
            get { return RegistryHelper.ReadInt(Configuration.REGKEY_CONFIG, REGVAL_SYSTEM_ID); }
        }

        public string SystemPassword
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_SYSTEM_PASSWORD); }
        }

        public string WebServiceHost
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_WEB_SERVICE_HOST); }
        }

        public string WebServiceProtocol
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_WEB_SERVICE_PROTOCOL); }
        }

        public string WebServiceProxy
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_WEB_SERVICE_PROXY); }
        }
        ...
        {
            get { return RegistryHelper.ReadInt(Configuration.REGKEY_CONFIG, REGVAL_TIME_INTERVAL, "60000"); }
        }

        public string DebugOutputPath
        {
            get { return RegistryHelper.ReadString(Configuration.REGKEY_CONFIG, REGVAL_DEBUG_OUTPUT); }
        }
