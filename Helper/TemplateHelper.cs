...
namespace MWS.Helper
{
    public static class TemplateHelper
    {
        ...
        {
            return XmlHelper.DeserializeFromFile(filename, MoveletType, defaultNameSpace) as MovilizerMovelet;
        }
        ...
        {
            return XmlHelper.DeserializeFromResourceCode(resourcePrefix + resourceCode, MoveletType, defaultNameSpace) as MovilizerMovelet;
        }

        public static MovilizerMovelet DeserializeMoveletFromResourceCode(string resourceCode, string defaultNameSpace)
        {
            return XmlHelper.DeserializeFromResourceCode(resourceCode, MoveletType, defaultNameSpace) as MovilizerMovelet;
        }
        ...
        {
            return XmlHelper.DeserializeFromFile(filename, MasterdataUpdateType, defaultNameSpace) as MovilizerMasterdataUpdate;
        }
        ...
        {
            return XmlHelper.DeserializeFromResourceCode(resourcePrefix + resourceCode, MasterdataUpdateType, defaultNameSpace) as MovilizerMasterdataUpdate;
        }
        ...
        {
            return XmlHelper.DeserializeFromResourceCode(resourceCode, MasterdataUpdateType, defaultNameSpace) as MovilizerMasterdataUpdate;
        }
        ...
        {
            return XmlHelper.DeserializeFromFile(filename, MasterdataDeleteType, defaultNameSpace) as MovilizerMasterdataDelete;
        }
        ...
        {
            return XmlHelper.DeserializeFromResourceCode(resourcePrefix + resourceCode, MasterdataDeleteType, defaultNameSpace) as MovilizerMasterdataDelete;
        }
        ...
        {
            return XmlHelper.DeserializeFromResourceCode(resourceCode, MasterdataDeleteType, defaultNameSpace) as MovilizerMasterdataDelete;
        }
    }
}
